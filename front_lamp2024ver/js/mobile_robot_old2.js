// numbers of robots
//const NUMROBOTS = ['No01', 'No02', 'No03', 'No04', 'No05', 'No06', 'No07', 'No08', 'No09', 'No10', 'No11', 'No12'];

// values of radio buttons
//const RADIOVALS = ['RBT01', 'RBT02', 'RBT03'];

// status codes for robots
/*
const RBTCONFIRM = '<font color="#00dd00">接続確認済<font>';
const RBTACTIVATE = '<font color="#ff0000">稼働中　　<font>';
const RBTACTFAIL = '<font color="#ff0000">起動失敗　<font>';
const RBTDEACT = '<font color="#cc00cc">停止中　　<font>';
const RBTDEACTFAIL = '<font color="#cc00cc">停止失敗　<font>';
*/
...
function onMessageArrived(message) {
  ...
  */
  ...
  switch(items_obj['lamp_num']){
    case 1:
      $('#lamp1').attr('src', color);
      break;
    case 2:
      $('#lamp2').attr('src', color);
      break;
    case 3:
      $('#lamp3').attr('src', color);
  }
